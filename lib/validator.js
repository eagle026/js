...
var Validator = {
	...
	//Mobile : /^((\(\d{2,3}\))|(\d{3}\-))?((13[0-9])|(15[^4,\D])|(17[0-9])|(18[0,5-9]))\d{8}$/,//edit by linkunyuan
	Mobile : /^\d{9,11}$/,//edit by linkunyuan
	Url : /^(http|https|ftp):\/\/\S+\.\w+/,//edit by linkunyuan
    VedioUrl : /^((https|http|ftp|rtsp|mms)?:\/\/)[^\s]+(rm|rmvb|avi|mp4|3gp)$/,
	...
	Repeat : "elt.value == fobj.elements[elt.getAttribute('to')].value",//edit by linkunyuan
